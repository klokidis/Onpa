...
fun Welcome(navigateSetUp: () -> Unit) {
    ...
    Column(
        ...
        AnimatedText(isVisible, stringResource(R.string.welcome_name), 1200)
    ...
    AnimatedVisibility(
        ...
        Text(
            ...
            modifier = Modifier
                ...
                .padding(
                    start = 15.dp,
                    top = if (isMedium) 10.dp else 3.dp,
                    end = if (isMedium) 50.dp else 0.dp
                ),
